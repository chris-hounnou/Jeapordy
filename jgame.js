...
async function setupAndStart() {
    ...
    let spinnerEl = document.getElementById('spin-container');
    if (spinnerEl) {
...
start.addEventListener('click', function (setupAndStart) {
    location.reload();
});
...
restartButton.addEventListener('click', function (setupAndStart) {
    location.reload();
});
